...
echo StyleSheet();
echo "</head><body>";
echo "<h1> Table <b>irp_brands</b>: <i>add/edit/delete records</i></h1>";
//--------------------------------------------------
...
$crud = new crudClass('irp_brands','brand,brn_url,bicon','brand' );// Initiate the class with table information
...
// or insert    
 ...
 // table   
echo $crud->renderVertically(' ORDER BY brand');// SHOW data table
